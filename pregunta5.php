           ...
           <div class ="row">
			 ...
			 <!--<img src="img/radio2.svg" alt="radio" style="max-width:35px; display:inline" > -->
				<div class="intro-text col-xs-12 col-sm-12 col-lg-12">
				      <span class="name"><h3>5. Arma el siguiente rompecabezas y descubre cómo se llamó el primer receptor de radio?</h3></span>
			 <!--<hr class="star-light">-->

					<!-- BOTONES DE NIVELES -->
          <div class="col-md-12 text-center">
            <div class="col-xs-12">
              <a href="total.php" class="btn btn-lg btn-block btn-outline">La radio de Galena
              </a>
            </div>
            <div class="col-xs-12">
              <a href="total.php" class="btn btn-lg btn-block btn-outline">La radio privada
              </a>
            </div>
            <div class="col-xs-12">
              <a href="total.php" class="btn btn-lg btn-block btn-outline">La radio estatal
              </a>
            </div>
          </div>
        </div>
