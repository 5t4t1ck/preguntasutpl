...
<body id="page-top" class="index">
   ...
   <!-- Navigation -->
    ...
    <header style=" background-image: url('img/confusing-background.png'); width: 100%; height:100%; background-repeat:no-repeat; background-position:center;">
           ...
           <div class ="row">
			 ...
			 <!--<img src="img/radio2.svg" alt="radio" style="max-width:35px; display:inline" > -->
				<div class="intro-text col-xs-12 col-sm-12 col-lg-12">
				      <span class="name"><h3>Usted a contestado</h3></span>
			 <hr class="star-light">
          ...
          <table border="0">
            <tr>
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <td>
                <div class="col-xs-12">
                  1<img src="img/bien.svg" alt="" width="75%"/>
                </div>
                </td>
                <td>
                <div class="col-xs-12">
                  2<img src="img/bien.svg" alt="" width="75%" />
                </div>
                </td>
                <td>
                <div class="col-xs-12">
                  3<img src="img/mal.svg" alt="" width="75%"/>
                </div>
                </td>
                <td>
                <div class="col-xs-12">
                  4<img src="img/mal.svg" alt="" width="75%"/>
                </div>
                </td>
                <td>
                <div class="col-xs-12">
                  5<img src="img/bien.svg" alt="" width="75%"/>
                </div>
                </td>
              </div>
          </tr>
        ...
        <div class="col-xs-12">
          <a href="menu.php" class="btn btn-lg btn-block btn-outline">Avance a la siguiente categoria
          </a>
        </div>
        </div>
      </div>
