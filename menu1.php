        ...
        <div class="container" id="jugar" >
            <div class="row">
				<div class="intro-text">
				    <span class="name">Selecciona la pregunta</span>
				  <hr class="star-light">
				    ...
				    <div class="col-lg-10 col-lg-offset-2 text-center">
    				    <div class="col-md-2 text-center">
							...
							<?php
								$c1p1=2;
								if ($p1==1){
									echo'<a href="radio" class="btn btn-lg btn-outline">
									1 <i class="fa fa-question-circle"></i>
									</a>';
								}else{
									echo '<a href="menu.php" class="btn btn-lg btn-outline">
