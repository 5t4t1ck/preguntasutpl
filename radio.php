			 ...
			 <!--<hr class="star-light">-->
					...
					<!-- BOTONES DE NIVELES -->
    				    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3">
									<a href='pregunta1.php' class='btn btn-lg btn-outline'>
										1 <i class='fa fa-lock '></i>
									</a>
    					</div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2">
                            <a href="pregunta2.php" class="btn btn-lg btn-outline">
         					    2 <i class="fa fa-question-circle"></i>
         					</a>
                         </div>
                         <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2">
                            <a href="pregunta3.php" class="btn btn-lg btn-outline">
      						    3 <i class="fa fa-question-circle"></i>
      						</a>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-2">
                            <a href="pregunta4.php" class="btn btn-lg btn-outline">
        					   4 <i class="fa fa-question-circle"></i>
        					</a>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3">
                            <a href="pregunta5.php" class="btn btn-lg btn-outline">
