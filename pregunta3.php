           ...
           <div class ="row">
			 ...
			 <!--<img src="img/radio2.svg" alt="radio" style="max-width:35px; display:inline" > -->
				<div class="intro-text col-xs-12 col-sm-12 col-lg-12">
				      <span class="name"><h3>3. ¿Cuál es el significado de F.M.?</h3></span>
			 <!--<hr class="star-light">-->

					<!-- BOTONES DE NIVELES -->
          <div class="col-md-12 text-center">
            <div class="col-xs-12">
              <a href="bien.php" class="btn btn-lg btn-block btn-outline">Frecuencia modulada
              </a>
            </div>
            <div class="col-xs-12">
              <a href="mal.php" class="btn btn-lg btn-block btn-outline">Fase mega
              </a>
            </div>
            <div class="col-xs-12">
              <a href="mal.php" class="btn btn-lg btn-block btn-outline">Foro métrico
              </a>
            </div>
          </div>
        </div>
