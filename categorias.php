		...
		$cat4=1;
			if ($cat1==1){
				echo '	<div class="col-xs-6">
							<a href="radio.php" class="btn btn-lg btn-block btn-outline">
			...
			if ($cat2==1){
				echo '	<div class="col-xs-6">
							<a href="historia.php" class="btn btn-lg btn-block btn-outline">
			...
			if ($cat3==1){
				echo '	<div class="col-xs-6">
							<a href="tv.php" class="btn btn-lg btn-block btn-outline">
			...
			if ($cat4==1){
				echo '	<div class="col-xs-6">
							<a href="teorias.php" class="btn btn-lg btn-block btn-outline">
